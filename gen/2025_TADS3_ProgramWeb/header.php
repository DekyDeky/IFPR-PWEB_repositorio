...
<html lang="pt-br">
    ...
    <body>
        ...
        <?php
            ...
            error_reporting(0); //Desabilitar reportanges de erros da execução
            session_start();
            ...
            if(isset($_SESSION['logado']) && $_SESSION['logado'] === true){
                ...
                $nomeCompleto   = explode(' ', $nomeUsuario); //Cria um array divido por espaços
                        ...
                        <?php 
                            ...
                            if(isset($_SESSION['logado']) && $_SESSION['logado'] === true){
                                echo "
                                    ...
                                    <li class='nav-item'>
                                        <a class='nav-link' style='color:lightblue'>Olá, <strong>$primeiroNome</strong></a>
                                    </li>
                                ";
                            }else {
                                echo "
