    ...
    <?php 
        ...
        if(isset($_GET['erroLogin'])){
            ...
            if($erroLogin == 'dadosInvalidos'){
                echo "<div class='alert alert-warning text-center'><strong>USUARIO OU SENHA</strong> inválidos</div>";
            }
            if($erroLogin == 'naoLogado'){
                echo "<div class='alert alert-warning text-center'><strong>USUARIO</strong> não logado</div>";
            }
